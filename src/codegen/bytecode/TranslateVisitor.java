...
public class TranslateVisitor implements ast.Visitor
{
	...
	public void visit(ast.exp.Call e)
	{
		...
		emit(new codegen.bytecode.stm.Invokevirtual(e.Id.id, e.type, at, rt));
		return;
	}
	...
	{
		emit(new codegen.bytecode.stm.New(e.Id.id));
		return;
	}
	...
	{
		d.type.accept(this);
		this.dec = new codegen.bytecode.dec.Dec(this.type, d.Id.id);
		this.indexTable.put(d.Id.id, index++);
		return;
	}
